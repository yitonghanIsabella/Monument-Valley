...
public:
	...
	// 绘制物体
    void drawMesh(TriMesh* mesh, openGLObject &object, Light *light, Camera* camera, bool isShadow = false);
	void drawSky(Shader skyboxShader, Camera* camera);
	void drawDynamicMesh(TriMesh* mesh, openGLObject& object, Light* light, Camera* camera, glm::mat4 modelMatrix, bool isShadow = false);
