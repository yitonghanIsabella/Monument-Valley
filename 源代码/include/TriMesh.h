...
protected:
	...
	*/
	//glm::vec4 ambient = glm::vec4(0.33, 0.22, 0.03, 1.0);				// 环境光
	glm::vec4 ambient = glm::vec4(0.97, 0.87, 0.04, 1.0);
	glm::vec4 diffuse = glm::vec4(0.78, 0.57, 0.015, 1.0);				// 漫反射
	glm::vec4 specular = glm::vec4(0.99, 0.94, 0.81, 1.0);				// 镜面反射
	float shininess = 131072;			// 高光系数
